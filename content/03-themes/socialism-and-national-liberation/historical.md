...
resources:
  - title: "Weavers of Revolution: The Yarur Workers and Chile's Road to Socialism"
    ...
    kind: book
    access: borrow
    url: "https://archive.org/details/weaversofrevolut00pete"
    note: "A ground-level history of textile workers who pushed Allende's government further than it wished to go, illuminating the tension between the peaceful road and worker self-activity."
  - title: "We Created Chávez: A People's History of the Venezuelan Revolution"
    authors: ["George Ciccariello-Maher"]
    year: 2013
    format: reading
    kind: book
    access: paywalled
    url: "https://www.dukeupress.edu/we-created-chavez"
    note: "Recasts the Bolivarian process as decades of grassroots movement-building rather than one leader's project, based on interviews with organizers and ex-guerrillas."
  - title: "Sandinista: Carlos Fonseca and the Nicaraguan Revolution"
  ...
  - title: "Reckoning with Revolution in Nicaragua"
    ...
    kind: article
    access: free
    url: "https://ageofrevolutions.com/2020/11/25/reckoning-with-revolution-in-nicaragua/"
    note: "Links the 1979 revolution and the Contra war to Ortega's later authoritarian turn, resisting both romance and demonization. A balanced 'betrayed revolution' framing."
  - title: "On the Coup in Bolivia"
    authors: ["NACLA Editorial Board"]
    year: 2019
    format: reading
    kind: article
    access: free
    url: "https://portside.org/2019-11-16/nacla-coup-bolivia-against-revanchist-violence-and-state-repression"
    note: "Calls the 2019 removal of Evo Morales a coup while naming the MAS government's own failures. A Latin-Americanist left position, coup-affirming but critical of the government it defends."
  - title: "Thomas Sankara Speaks: The Burkina Faso Revolution, 1983 to 1987"
    authors: ["Thomas Sankara"]
    year: 1988
    format: reading
    kind: book
    access: borrow
    url: "https://archive.org/details/thomassankaraspe00sankrich"
    note: "Forty-plus speeches and interviews, the primary record of the Burkinabe revolution in Sankara's own voice, ending at his 1987 assassination. The essential source on the period."
  - title: "The Arusha Declaration"
    authors: ["Julius Nyerere"]
    year: 1967
    format: reading
    kind: primary-source
    access: free
    url: "https://www.marxists.org/subject/africa/nyerere/1967/arusha-declaration.htm"
    note: "The founding program of Tanzanian Ujamaa: self-reliance, rural socialism, and a leadership code against a new privileged class. The vision as officially stated, before the harder record."
  - title: "The Fall of Kwame Nkrumah"
    authors: ["Sojourner Truth Organization"]
    format: reading
    kind: article
    access: free
    url: "https://www.marxists.org/history/usa/pubs/sojournertruth/nkrumah.html"
    note: "Ghana's independence under Nkrumah and his 1966 overthrow, told by an independent-Marxist group that is sober about the one-party state's own limits, not only the Western hand in his fall."
  - title: "Maurice Bishop's Execution: The Day the Grenada Revolution Died"
    authors: ["Village Voice News (Grenada)"]
    year: 2025
    format: reading
    kind: article
    access: free
    url: "https://villagevoicenews.com/2025/10/19/maurice-bishops-execution-the-day-the-grenada-revolution-died/"
    note: "A Caribbean narrative of the 1983 Coard-Bishop split and the Fort Rupert executions that destroyed the revolution from within, days before the US invasion. Honest about the implosion."
  - title: "Cuban Revolution (Cold War documentary)"
...
This is the final part of the socialism series, and it follows the revolution out of Europe and into the colonized and formerly colonized world, where socialism and national liberation fused. The stories here run from Cuba and Allende's Chile through Sandinista Nicaragua and Evo Morales's Bolivia, and across Africa from Sankara's Burkina Faso to Nyerere's Tanzania and Nkrumah's Ghana, to the brief revolution in Grenada. They are stories of extraordinary hope and, often, of siege, coup, and implosion, and this lens tells them from more than one side. It builds on the national-liberation histories in [[03-themes/imperialism-and-the-global-system/index|Imperialism and the Global System]] and continues the series from [[03-themes/revolution-in-power/index|Revolution in Power]].

## Anchor questions

- What did these revolutions promise the poor of the Global South, and where did they deliver?
- How much of each story is internal, and how much is coup, blockade, and the long arm of empire?
- Grenada's revolution destroyed itself before the US invaded. Nicaragua's turned authoritarian. What do the implosions teach?
- Why do we know Che and Castro but not Sankara, Cabral, or Bishop?
- Whose telling of these histories have we inherited, and who wrote it?

## Materials

Free unless marked otherwise. "Free to borrow" means a free Internet Archive account and a renewable loan. Standpoints are noted; the sources are meant to be read against one another.

### Cuba, Chile, and Venezuela

- **The Cuban Revolution** (The Cold War, 2022, 19 min). A mainstream video baseline on Batista's fall and Castro's rise. Free: [youtube.com/watch?v=kDeKySs_nxw](https://www.youtube.com/watch?v=kDeKySs_nxw)
- **Peter Winn** (b. 1942), _Weavers of Revolution_ (1986). Chilean workers who pushed Allende further than he wished to go, the peaceful road against worker self-activity. Free to borrow: [archive.org](https://archive.org/details/weaversofrevolut00pete)
- **George Ciccariello-Maher**, _We Created Chávez_ (2013). The Bolivarian process as decades of grassroots movement-building, not one leader's project. Not free; [publisher page](https://www.dukeupress.edu/we-created-chavez).
...
- **Thomas Sankara** (1949 to 1987), _Thomas Sankara Speaks_ (1988). The Burkinabe revolution in his own voice, to his assassination. Free to borrow: [archive.org](https://archive.org/details/thomassankaraspe00sankrich)
