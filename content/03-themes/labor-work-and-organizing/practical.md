...
resources:
  - title: "Working People"
    ...
    note: "Long-form interviews with rank-and-file workers about their jobs, struggles, and organizing. The best workers-in-their-own-words audio for this school."
  - title: "The Valley Labor Report"
    authors: ["Jacob Morrison", "Adam Keller"]
    year: 2020
    format: podcast
    kind: series
    access: free
    url: "https://tvlr.fm/"
    note: "Alabama's union talk-radio show, with recurring segments on Southern organizing drives, contract fights, and worker deaths."
  - title: "Belabored"
    authors: ["Sarah Jaffe", "Michelle Chen", "Dissent"]
    year: 2013
    format: podcast
    kind: series
    access: free
    url: "https://podcasts.apple.com/us/podcast/belabored/id634955549"
    note: "A biweekly news-and-analysis show (2013 to 2023) interviewing organizers and journalists about strikes and campaigns across sectors. A deep back catalog."
  - title: "Union"
    authors: ["Stephen Maing", "Brett Story"]
    year: 2024
    format: film
    kind: documentary
    access: free
    length: "90 min"
    url: "https://www.pbs.org/pov/films/unionfilm/"
    note: "A verite chronicle of the Amazon Labor Union's grassroots drive at the Staten Island JFK8 warehouse. The definitive on-the-ground film of a contemporary campaign. Free via PBS POV, with discussion guides."
  - title: "Harlan County USA"
    ...
    access: paywalled
    length: "103 min"
    url: "https://www.criterion.com/films/777-harlan-county-usa"
    note: "The Academy Award-winning record of the 1973 to 1974 Brookside coal miners' strike, filmed on the picket line under real threat of violence. Free with a library card on Kanopy where available."
  - title: "Secrets of a Successful Organizer"
    ...
    note: "Forty-seven concrete practices for building power on the job. The free handouts, exercises, and trainer's guide amount to a ready-made workshop curriculum, in English and Spanish."
  - title: "Labor Notes"
    authors: ["Labor Notes"]
    year: 1979
    format: reading
    ...
    note: "The rank-and-file labor magazine and organizing project, reporting inventive tactics and contract campaigns to put the movement back in the labor movement."
  - title: "More Perfect Union"
    authors: ["More Perfect Union"]
    year: 2021
    format: reading
    kind: journalism
    access: free
    url: "https://perfectunion.us/"
    note: "A nonprofit newsroom producing short, shareable explainers on labor disputes, gig work, and corporate accountability from a working-class lens."
  - title: "Rules for Radicals: A Practical Primer for Realistic Radicals"
    authors: ["Saul D. Alinsky"]
    year: 1971
    format: reading
    kind: handbook
    access: paywalled
  ...
  - title: "Why Corporate America Hates Unions"
    ...
    access: free
    length: "18 min"
    url: "https://www.youtube.com/watch?v=yv0QJVqovDo"
    note: "About 742,000 views. Walks through union-busting tactics and the recent Amazon, Starbucks, and REI wins."
  - title: "Starbucks Tried to Crush Its Baristas. What Happened Next Will Shock You"
    authors: ["More Perfect Union"]
    year: 2024
    format: video
    kind: explainer
    access: free
    length: "12 min"
    url: "https://www.youtube.com/watch?v=w9V-o8ckKyg"
    note: "About 350,000 views. Follows baristas forcing Starbucks toward the bargaining table. A strong practical case study."
  - title: "We Just Unionized Amazon: How Two Best Friends Beat the Retail Giant"
    ...
    access: free
    length: "28 min"
    url: "https://www.youtube.com/watch?v=82UEYmJs0jQ"
    note: "About 183,000 views. A long interview with Chris Smalls and Derrick Palmer on how the first Amazon union won. A deep practical companion."
  - title: "How To Start A Union: Step By Step"
    authors: ["More Perfect Union"]
    year: 2022
    format: video
    kind: explainer
...
- **Labor Notes** (1979 to present). The rank-and-file labor magazine and organizing project, reporting inventive organizing tactics and contract campaigns "to put the movement back in the labor movement." The core practical outlet, and the publisher of the handbook below. Free: [labornotes.org](https://www.labornotes.org/)
- **More Perfect Union** (2021 to present). A nonprofit video-journalism newsroom producing short, shareable explainers on labor disputes, gig work, and corporate accountability from a working-class lens. Excellent for session openers. Free: [perfectunion.us](https://perfectunion.us/)
...
- **Working People** (Maximillian Alvarez, 2016 to present). First-person interviews with rank-and-file workers about their jobs, struggles, and organizing, from warehouses to rail to graduate-student strikes. The best "workers in their own words, today" audio for this school. Free main feed. [inthesetimes.com](https://inthesetimes.com/podcasts/working-people)
- **The Valley Labor Report** (Jacob Morrison and Adam Keller, 2020 to present). Alabama's union talk-radio show, with recurring segments like "Last Week in Southern Labor" and "Boss Watch." Valuable for a view of organizing in the South, where union density is lowest. Free: [tvlr.fm](https://tvlr.fm/)
- **Belabored** (Sarah Jaffe and Michelle Chen, Dissent, 2013 to 2023). A biweekly news-and-analysis show interviewing journalists, academics, and organizers about strikes and campaigns across sectors. The back catalog is a deep, searchable record of the last decade of labor struggle. Free: [podcasts.apple.com](https://podcasts.apple.com/us/podcast/belabored/id634955549)

### Explainers and case studies on video

- **"Why Corporate America Hates Unions"** (Second Thought, 2022). Roughly 18 minutes, about 742,000 views. Walks through union-busting tactics and the recent Amazon, Starbucks, and REI wins. A strong practical opener. [youtube.com/watch?v=yv0QJVqovDo](https://www.youtube.com/watch?v=yv0QJVqovDo)
...
First pass, and it may be a while before there is a second. Contributions welcome, especially case studies and accounts from groups that have run local sessions, and material on organizing outside the workplace, in tenant unions, and in the informal economy.
