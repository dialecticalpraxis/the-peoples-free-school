...
If you have not yet read the [[01-founding-statement|Founding Statement]] and the [[02-pedagogy|Pedagogy]] document, start with those. This guide assumes you have.

## Read together first

Before you call yourselves a school, read _We Make the Road by Walking_ with a few people. The book is itself a model of what the school tries to do. Reading it together gives your initial group a shared reference point and a felt sense of the practice. It also tests whether the group has the patience for slow, collective work. If reading one book together is more than the group can sustain, the school will not survive its first six months.

Five or six weeks is a reasonable pace. Meet weekly or every other week. Take a chapter or section at a time. At each meeting, share what struck you, what confused you, what connected to your own life. Practice the opening and closing rituals described in the [[opening-and-closing-practices|opening and closing practices]] document. Notice what works and what does not.
...
- What did your reading of _We Make the Road by Walking_ surface that the group wants to go further on?

You do not need to start with "How Capitalism Works" just because it appears first in the library. Start where the heat is. The library is a pool to draw from, not a sequence to march through.
...
- "Why is housing so expensive, and what can be done?" (combines How Capitalism Works, Gender, Reproduction, and the Household, and The State, Strategy, and Power)
...
Most schools find a primary rhythm and supplement it with occasional intensives. See the [[02-session-templates/index|session templates]] for guidance on each format.

## Prepare your first session

Once you have a theme, a space, a date, and a core group, you can plan your first session.

For a single session, see [[single-session|the single session template]]. For a multi-week arc, see [[study-circle-6week|the study circle template]].
...
Consider contributing back. Pull requests to the main repository with new resources, session notes, or examples of work in your community help every other group that uses the model. See [the contributing guide](https://github.com/dialecticalpraxis/the-peoples-free-school/blob/main/CONTRIBUTING.md) for details.
...
If you are starting a school and have questions, the project maintainers are happy to hear from you. See the repository [README](https://github.com/dialecticalpraxis/the-peoples-free-school/blob/main/README.md) for contact information.
